...
def train():
    ...
    for epoch in range(EPOCH):
        ...
        write.add_scalars("energy", {'MADDPG': epoch_average_energy_reward[epoch],
        ...
        print("epoch:{},energy:{}".format(epoch, epoch_average_energy_reward[epoch]))
        print("epoch:{},delay:{}".format(epoch, epoch_average_time_reward[epoch]))
